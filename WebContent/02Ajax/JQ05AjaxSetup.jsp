...
/*
	$.ajaxSetup()
		...
		인자를 생략할수 있다. type, dataType등 기본적으로
		사용되는 인자들을 묶어주면 편리하다.
 */
$(function() {
	...
	$.ajaxSetup({
		...
		dataType : "json" //콜백해주는 데이터타입이 json
	});
	...
	$('#btn').click(function() {
		$.ajax({
			success : function(responseData) {
				/*
				콜백데이터는 JSON 배열이므로 each()를 통해 인자의 갯수만큼 반복한다.
