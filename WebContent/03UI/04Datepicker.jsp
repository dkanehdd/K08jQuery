...
$( function() {
	...
	$( "#datepicker1" ).datepicker({
		"dateFormat" : "yy-mm-dd" //날짜 형식 yyyy_mm_dd 형식으로 나온다
	});
    ...
    $("#datepicker4").datepicker({
        ...
        changeYear: true,
        numberOfMonths: 3,
        showButtonPanel: true //달력 아래에 Today가 뜸
    });
    $("#datepicker5").datepicker({
 	 ...
 	 //아이콘 CSS적용
    $('img.ui-datepicker-trigger').css({'cursor':'pointer', 'position':'relative', 'top':'-2px', 'width':'29px'});  //아이콘(icon) 위치
